...
const Products = () => {
  ...
  const {products,search,setSearch,categories,category,setCategory,totalPages,price,setPrice,page,setPage,loading} =ProductData();
  ...
  return (
    <div className='flex flex-col md:flex-row h-full'>
      <div className={`fixed inset-y-0 left-0 z-50 md:z-40 w-64 bg-white
         ...
         duration-300 ease-in-out md:relative md:translate-x-0 ${show?"translate-x-0":"-translate-x-full"}`}>
      ...
      <div className="flex-1 p-4">
        ...
        {
          loading?<Loading/>:<div className='grid grid-cols-1  md:grid-cols-2 lg:grid-cols-4 gap-6'>
